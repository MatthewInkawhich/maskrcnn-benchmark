...
_C.MODEL.DDPP.USE_CASCADE_BODY = False
...
_C.MODEL.STRIDER.STEM_CONFIG = "BASE"
_C.MODEL.STRIDER.STEM_CHANNELS = [64]
...
_C.MODEL.STRIDER.DILATIONS = [1, 1, 1]
_C.MODEL.STRIDER.WEIGHTED_FUSION = False
...
_C.MODEL.EWADAPTIVE.GENERATE_SELECTOR_GTS_BATCH_SIZE = 2
_C.MODEL.EWADAPTIVE.GENERATE_SELECTOR_GTS_PRE_NMS_TOP_N = 16000
_C.MODEL.EWADAPTIVE.GENERATE_SELECTOR_GTS_POST_NMS_TOP_N = 4000
...
_C.SOLVER.LOSS_WEIGHTING.STEP_M = 100
